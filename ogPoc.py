...
background2 = ImageClip("background.jpg").set_duration(overlay_video.duration).resize((100, 100))
background2 = background2.set_position(lambda t: move_overlay(t, transitions2))

# Create composite video with layers
final_clip = CompositeVideoClip([background, overlay_video, background2])
